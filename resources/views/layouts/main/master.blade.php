...
<link rel="preload" as="style" type="text/css" href="{{asset('frontend/css/bootstrap.css')}}" onload="this.rel='stylesheet'" />
<link href="{{asset('frontend/css/bootstrap.css')}}" rel="stylesheet" type="text/css" />
<link rel="preload" as="style" type="text/css" href="{{asset('frontend/css/evo-main.scss.css')}}" onload="this.rel='stylesheet'" />
<link href="{{asset('frontend/css/evo-main.scss.css')}}" rel="stylesheet" type="text/css" />
<link rel="preload" as="style" type="text/css" href="{{asset('frontend/css/evo-index.scss.css')}}" onload="this.rel='stylesheet'" />
<link href="{{asset('frontend/css/evo-index.scss.css')}}" rel="stylesheet" type="text/css" />
<link rel="preload" as="style" type="text/css" href="{{asset('frontend/css/ant-tools.scss.css')}}" onload="this.rel='stylesheet'" />				
<link href="{{asset('frontend/css/ant-tools.scss.css')}}" rel="stylesheet" type="text/css" />
...
<link rel="preload" as="script" href="{{asset('frontend/js/slick.js')}}" />
...
@yield('js')
<script>
   $('.add_to_cart, .btn-buy-now, .btn-buy-now-click').click(function(e) {
      e.preventDefault();
      ...
      $.ajax({
         ...
         success: function(data) {
            ...
            $('#cart-sidebars').html(data.html);
            $('.count_item_pr').html(data.html1);
   ...
   function btnMinus(e) {
      var id = e;
      var url = $('.select-quantity').data('url');
      var result = document.getElementById('qtyItem'+id); var qtyItem = result.value; if( !isNaN( qtyItem ) && qtyItem > 1 ) result.value--;
   ...
   function btnPlus(e) {
      var id = e;
      var url = $('.select-quantity').data('url');
      var result = document.getElementById('qtyItem'+id); var qtyItem = result.value; if( !isNaN( qtyItem )) result.value++;
      var quantity = result.value;
      console.log(url);
      $.ajax({
         type: 'post',
...
<div class="addThis_listSharing addThis_listing">
   <div class="addThis_item">
         <a class="addThis_item--icon" href="tel:{{$setting->phone1}}" rel="nofollow" aria-label="phone" title="Gọi ngay cho chúng tôi">
   ...
   <div class="addThis_item">
         <a class="addThis_item--icon" href="//zalo.me/{{$setting->phone1}}" target="_blank"  rel="nofollow noreferrer" aria-label="zalo" title="Chat với chúng tôi qua Zalo">
         <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
   ...
   <div class="addThis_item">
         <a class="addThis_item--icon" href="mailto:{{$setting->email}}" aria-label="email" title="Gửi email cho chúng tôi">
         <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
   ...
   <div class="addThis_item" >
         <a class="addThis_item--icon" href="{{route('lienHe')}}" aria-label="Liên hệ" title="Xem địa chỉ doanh nghiệp">
         <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
