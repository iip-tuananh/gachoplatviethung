...
<div class="evo-product-item">
   ...
   <div class="flex-prices">
      ...
      @endif
      <form action="" method="post" enctype="multipart/form-data" class="button-add hidden-sm hidden-xs hidden-md variants form-nut-grid form-ajaxtocart" >
            <input type="hidden" name="variantId" value="{{$product->id}}" />
            <button type="button" title="Thêm vào giỏ" class="action add_to_cart" data-url="{{route('addToCart')}}">
